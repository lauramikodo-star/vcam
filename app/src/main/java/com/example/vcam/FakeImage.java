...
public class FakeImage extends Image {
    ...
    private static class FakePlane extends Image.Plane {
        ...
        public ByteBuffer getBuffer() {
            // Return a slice or duplicate to prevent position modifications affecting others?
            // Standard ImageReader returns direct buffers usually, but wrapped heap buffer is fine for fake.
            return mBuffer;
        }
    }
}
